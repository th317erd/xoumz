module.exports = function(root, requireModule) {
  ...
  class LazyCollection {
    ...
    itemMutator(cb) {
      ...
      definePropertyRW(this, '_mutator', async (_item, index) => {
        var item = (func instanceof Function) ? await func.call(this, _item, index) : _item;
        return await cb.call(this, item, index);
      });
    ...
    async index(offset) {
      ...
      return (mutator instanceof Function) ? await mutator.call(this, item, offset) : item;
    }
