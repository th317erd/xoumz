module.exports = function(root, requireModule) {
  ...
  function groupCondition(cb, flags) {
    var group = new QueryEngine(this.getConnector(), this.getModelType(), this.options);
  ...
  class QueryEngine {
    ...
    constructor(connector, modelType, _opts) {
      var opts = _opts || {};
      ...
      definePropertyRO(this, 'first', undefined, async () => {
        var result = await this.getConnector().query(this.getModelType(), this, this.options);
