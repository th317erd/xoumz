  ...
  class Application {
    ...
    defineClass(callback, _parentClass, staticMethods) {
      var ParentClass = _parentClass || this.getApplicationContextClass(),
          Klass = this.Utils.copyStaticMethods(callback.call(this, ParentClass, this), this.wrapClass(ParentClass));

      return Object.assign(Klass, staticMethods || {});
    }
      ...
      if (!('getEngine' in proto)) {
        Object.defineProperty(proto, 'getEngine', {
          ...
          value: function getEngine(engine, _opts) {
            var opts = _opts || {},
                context = (typeof this.context === 'function') ? this.getContext() : undefined;

            if (context && !('context' in opts))
              opts = Object.assign({}, opts, { context });

            return self.getEngine(engine, opts);
          }
        });
      }
