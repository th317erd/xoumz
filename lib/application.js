...
(function(root) {
  class Application {
    ...
    newQueryEngine(connector, _opts) {
      var QueryEngineClass = this.wrapClass(this.QueryEngine);
      return new QueryEngineClass(connector, _opts);
    }
    ...
    query(_opts) {
      ...
      return this.newQueryEngine(connector, opts);
    }
  }
