...
module.exports = function(root, requireModule) {
  ...
  return function(defineSchema) {
    return defineSchema(null, {
      version: 1,
      schema: function({ User, Role, String, Date, Integer, ArrayOf }, parent) {
        return {
          'userName': String.notNull.required,
          'password': String.notNull.required.validator(password, 'init').setter(function(val) {
            if (salt === undefined)
