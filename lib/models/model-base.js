module.exports = function(root, requireModule) {
  ...
  function defineModelField(fieldName, field) {
    ...
    Object.defineProperty(this, realValueKey, {
      ...
      enumerable: true,
      configurable: true,
      value: new ModelClass(defaultValue)
    });
    ...
    Object.defineProperty(this, fieldName, {
      ...
      get: () => {
        var getter = field.getProp('getter'),
            rawValue = this[realValueKey];

        var value = (typeof getter === 'function') ? getter.call(this, rawValue, field) : rawValue;
      ...
      set: (val) => {
        var setter = field.getProp('setter'),
            value = (typeof getter === 'function') ? setter.call(this, val, field) : val;

        if (value !== undefined && value !== null)
          value = value.valueOf();

        return (this[realValueKey] = new ModelClass(value));
      }
    });
  }
