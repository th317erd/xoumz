...
module.exports = function(root, requireModule) {
  ...
  class ContentTypeFile extends ContentType {
    constructor(data, _opts) {
      var opts = _opts || {};

      super(data, opts);

      if (noe(opts.fileName))
        throw new Error('"fileName" required for ContentTypeFile type');
      ...
      definePropertyRO(this, 'data', undefined, () => {
        ...
        if (!this.hasOwnProperty('_stream')) {
          d = fs.createReadStream(this.options.fileName, { encoding: this.options.encoding });
