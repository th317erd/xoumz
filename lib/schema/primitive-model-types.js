module.exports = function(root, requireModule) {
  ...
  const BooleanType = this.wrapClass(class BooleanType extends SchemaType {
    constructor() {
      super(BooleanPrimitive);
    }
  });
  ...
  const DateType = this.wrapClass(class DateType extends SchemaType {
    constructor() {
      super(DatePrimitive);
    }
  });
