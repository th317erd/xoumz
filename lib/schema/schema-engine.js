module.exports = function(root, requireModule) {
  ...
  class SchemaEngine {
    ...
    iteratePrimitiveSchemaTypes(cb) {
      var defaultSchemaTypes = SchemaTypes.getPrimitiveSchemaTypes(this.getSchemaTypeClass(), this.getModelTypeClass()),
    ...
    getSchemaTypes(_modelType) {
      ...
      this.iteratePrimitiveSchemaTypes((name, typeClass) => {
        definePropertyRO(schemaTypes, name, undefined, () => {
          ...
          var AppTypeClass = application.wrapClass(typeClass);

          if (typeClass.requiresArguments) {
            return (...args) => {
              return new AppTypeClass(this, modelType, ...args);
            };
          }

          return new AppTypeClass(this, modelType);
        }, () => {
      ...
      this.iteratePrimitiveSchemaTypes((name, typeClass) => {
        ...
        this.registerModelType(name, function(ModelBase) {
          ...
          return class PrimitiveModel extends ModelBase {
            ...
            // static instantiate(data, ...args) {
            //   var instance = (new typeInfo.primitiveType(schemaEngine, typeInfo.modelType)).instantiate(data.value || data, ...args);
            //   return instance;
            // }
