module.exports = function(root, requireModule) {
  ...
  function defineDefaultSchemaTypes(SchemaType) {
    ...
    function decomposeOwnerField(typeName, _val, _opts) {
      ...
      if (!ownerType || !(ownerType.getModelType instanceof Function))
    ...
    class StringType extends SchemaType {
      constructor(schema, model, type) {
        super(schema, model, type || 'String');
    ...
    class ArrayOfType extends SchemaType {
      ...
      decompose(_val, _opts) {
        ...
        var opts = _opts || {},
            ...
            modelType = this.parentSchema.getModelType(internalType.getTypeName());
    ...
    class OneOfType extends SchemaType {
      constructor(schema, model, ...types) {
        super(schema, model, 'Variant');
