module.exports = function(root, requireModule) {
  ...
  class ModelType {
    ...
    getDefaultPrimaryKeyField(schemaCode) {
      ...
      return this.getSchemaTypes().String.primaryKey.getter((val) => {
    ...
    iterateFields(cb, _opts) {
      ...
      for (var i = 0, il = fieldNames.length; i < il; i++) {
        ...
        if (opts.onlyReal && (fieldSchema.getProp('virtual', opts.context) || !isPrimitiveType(schemaEngine, fieldSchema)))
          continue;
