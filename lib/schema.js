...
class Schema {
  ...
  fieldValue(model, fieldKey, value) {
    ...
    var fieldValueFunc = (arguments.length === 2) ? field.getValue : field.setValue;
  ...
  serialize(model) {
    ...
    var serializeFunc = this._schema.serialize,
        self = this,
  ...
  unserialize(rawData) {
    ...
    var unserializeFunc = this._schema.unserialize,
        self = this;
