module.exports = function(root, requireModule) {
  ...
  class BaseConnector {
    ...
    async write(data, _opts) {
      ...
      var rets = await this.transaction((connectionOpts) => {
    ...
    async transaction(cb) {
      ...
      try {
        var ret = await cb.call(this, connection);
        await this.endTransaction(null, connection);
        return ret;
      } catch (e) {
        await this.endTransaction(e, connection);
        throw e;
      }
    }
  }
