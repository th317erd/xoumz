...
module.exports = function(root, requireModule) {
  ...
  const SQLiteConnector = this.defineClass((BaseSQLConnector) => {
    return class SQLiteConnector extends BaseSQLConnector {
      ...
      // WIP: need to be able to handle transactions within transactions
      ...
      async generateTableCreateQueries(modelClass, _opts) {
        ...
        for (var field of modelSchema.values({ hidden: false, virtual: false, primitive: true })) {
      ...
      async generateTableUpdateQueries(modelClass, _opts) {
        ...
        var createQuery = await this.generateTableCreateQueries(modelClass, opts);
